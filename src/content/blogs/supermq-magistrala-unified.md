...
- **[A0](https://www.absmach.eu/products/a0)** — modular IoT gateway solutions for smart metering, industrial IoT, and edge computing. The A0 module and Base Board deliver multi-protocol connectivity with open-source hardware and professional support.
