...
export interface Solution {
  ...
  challenges: {
    title: string;
    subtitle: string;
    items: [SolutionItem, SolutionItem, SolutionItem];
  };
...
export const solutions: Solution[] = [
  {
    ...
    dashboardScreenshots: [
      {
        src: "/img/solutions/smart-water/kpi-dashboard.png",
        alt: "KPI Dashboard showing total consumption, network pressure, and water quality status",
      },
      {
        src: "/img/solutions/smart-water/real-time-dashboard.png",
        alt: "Real-Time Monitoring Dashboard with live flow rate, pressure trend, and active alarms",
      },
      {
        src: "/img/solutions/smart-water/consumption-dashboard.png",
        alt: "Consumption Analytics Dashboard with historical usage trends",
      },
      {
        src: "/img/solutions/smart-water/alarms-dashboard.png",
    ...
    applications: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "Tenants see their own usage. Building managers get aggregate consumption and burst alarms.",
        },
        {
          ic: Droplets,
          title: "Water quality compliance for regulated supplies",
          desc: "Continuous WHO-threshold monitoring. Weekly compliance reports delivered automatically.",
        },
        {
          ic: Gauge,
    ...
    metaDescription:
      "Monitor water flow, pressure, and tank levels in real time. Detect leaks within seconds, automate compliance reports, and reduce NRW losses with Magistrala.",
  },

  {
    ...
    dashboardScreenshots: [
      {
        src: "/img/magistrala/dashboard-1.png",
        alt: "Smart City operations overview dashboard",
      },
      {
        src: "/img/magistrala/alarms-1.png",
        alt: "Smart City alarm management panel",
      },
      {
        src: "/img/magistrala/dashboard-2.png",
        alt: "Smart City live telemetry dashboard",
      },
      {
        src: "/img/magistrala/rules-engine-1.png",
    ...
    howItWorks: {
      ...
      steps: [
        ...
        {
          title: "Act",
          desc: "Operators receive alarms in the dashboard, automated notifications are dispatched, and downstream actuators can be triggered via outbound channels.",
        },
      ],
    },
    applications: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "Fill-level sensors route collection vehicles only to full bins, cutting collection kilometres by up to 40%.",
        },
        {
          ic: ShieldAlert,
    ...
    faq: [
      {
        ...
        answer:
          "Yes. Magistrala exposes REST and WebSocket APIs that integrate with GIS platforms, ERP systems, and city dashboards such as Esri ArcGIS and SAP. Webhook sinks push events directly to existing ticketing and dispatch systems.",
      },
      {
        question: "How do you handle multi-tenancy across city departments?",
        answer:
          "Magistrala uses domain-level isolation backed by SpiceDB policies. Each department operates in its own domain with its own device groups, channels, and user roles. Cross-domain data sharing is configured explicitly through policy grants.",
      },
      {
        question:
          "What happens if connectivity to the central platform is lost?",
        answer:
          "Edge gateway nodes buffer messages locally during connectivity gaps and replay them in order once the link is restored. Time-series data arrives with original device timestamps.",
      },
      {
        question: "How quickly can the Smart City pack be deployed?",
        answer:
          "The pre-configured pack installs on Magistrala Cloud in minutes; clients, channels, rules, dashboards, and alarms are all included. Custom device types and additional integrations can be added incrementally.",
      },
    ],
    metaDescription:
      "Deploy a smart city IoT platform in minutes. Pre-configured traffic, lighting, waste, and energy monitoring on Magistrala — ready out of the box.",
  },

  {
    ...
    dashboardScreenshots: [
      ...
      {
        src: "/img/magistrala/alarms-1.png",
        alt: "Energy grid alarm management",
      },
      {
        src: "/img/magistrala/rules-engine-1.png",
    ...
    howItWorks: {
      ...
      steps: [
        ...
        {
          title: "Respond",
          desc: "Operators receive actionable alarms. Demand response rules can trigger downstream actuation: load shedding, storage dispatch, or curtailment signals.",
        },
      ],
    },
    applications: {
    ...
    faq: [
      {
        ...
        answer:
          "Magistrala natively supports MQTT, HTTP, CoAP, and WebSocket. Smart meters and inverters using Modbus, IEC 61850, or DNP3 connect via an external protocol adapter.",
      },
      {
        question: "How does demand response automation work?",
        answer:
          "Demand response rules monitor real-time load and generation data against configurable thresholds. When a threshold is breached, the rules engine triggers load-shedding commands and notifies dispatch operators.",
      },
      {
        question:
          "Can we monitor multiple grid zones or substations from one platform?",
        answer:
          "Yes. Magistrala's multi-tenant architecture lets you organize substations, feeders, and distributed energy resources into separate domains with their own access policies.",
      },
      {
        question:
          "How is power quality event data handled for compliance reporting?",
        answer:
          "Sub-second telemetry resolution captures voltage sags, harmonics, and frequency deviations. Automated daily and monthly compliance reports are generated from raw event data.",
      },
    ],
    metaDescription:
      "Deploy smart grid monitoring in minutes. The Magistrala Smart Energy Pack includes pre-configured meters, demand response rules, and grid fault dashboards.",
  },

  {
    ...
    dashboardScreenshots: [
      {
        src: "/img/solutions/cold-storage/operations-overview-dashboard.png",
        alt: "Cold Storage Operations Overview with frozen zone and chilled zone temperature gauges",
      },
      {
        src: "/img/solutions/cold-storage/energy-power-dashboard.png",
        alt: "Energy & Power Dashboard with refrigeration unit power draw gauges",
      },
      {
        src: "/img/solutions/cold-storage/alarms-dashboard.png",
        alt: "Alarm Monitoring Dashboard with active alarm counts by severity",
      },
      {
        src: "/img/solutions/cold-storage/cold-room-status-template.png",
        alt: "Cold Room Status template showing live temperature, humidity, CO2, and door status",
      },
    ],
    challenges: {
      ...
      items: [
        {
          ...
          desc: "A compressor fault or door left ajar during a late loading run can push a frozen room toward the −12 °C HACCP critical limit in hours.",
        },
        {
          ic: ClipboardX,
          title: "Paper logs that are incomplete when the auditor arrives",
          desc: "Manual temperature logs have gaps during nights, weekends, and busy periods. When a food safety regulator asks for 30 days of records, incomplete logs mean failed audits.",
        },
        {
          ic: Wrench,
    ...
    howItWorks: {
      ...
      steps: [
        {
          title: "Ingest",
          desc: "Temperature/humidity sensors, CO2 monitors, door sensors, power supply monitor, and energy meters publish SenML readings over MQTT to the Telemetry Channel.",
        },
        {
          title: "Detect",
          desc: "Eight rules evaluate every incoming record in real time. Frozen zone above −15 °C fires a Warning; above −12 °C fires Critical. Door open beyond 120 seconds fires a Warning.",
        },
        {
          title: "Alert",
          desc: "Alarms appear on the dashboard the moment a threshold is crossed. Email notifications go to configured recipients with the device, measurement, value, and threshold included.",
        },
        {
          title: "Report",
          desc: "Daily temperature logs, weekly energy consumption reports, and monthly HACCP compliance summaries run automatically and deliver by email.",
        },
      ],
    },
    applications: {
      ...
      items: [
        {
          ...
          desc: "Continuous zone-specific monitoring against HACCP critical limits. Warning alarms fire at −15 °C and +5 °C, giving operators a response window.",
        },
        {
          ic: FlaskConical,
          title: "Pharmaceutical cold storage",
          desc: "Temperature-sensitive drugs and vaccines monitored against WHO PQS and GDP guidelines. CO2 level monitoring provides additional worker safety coverage.",
        },
        {
          ic: Wrench,
          title: "Refrigeration equipment health monitoring",
          desc: "Compressor power draw tracked against the normal operating range. Energy anomaly warnings fire before mechanical failure forces a room shutdown.",
        },
        {
          ic: FileCheck,
          title: "Regulatory compliance reporting",
          desc: "Monthly HACCP compliance summaries with temperature history and exceedance alarm counts per zone, ready for food safety authority submissions.",
        },
      ],
    },
    benefits: [
    ...
    metaDescription:
      "Monitor cold storage zones against HACCP thresholds in real time. Includes temperature, humidity, CO2 safety monitoring, and automated HACCP compliance reports.",
  },

  {
    ...
    dashboardScreenshots: [
      ...
      {
        src: "/img/magistrala/alarms-2.png",
        alt: "Crop stress and soil condition alarms",
      },
      {
        src: "/img/magistrala/reports-2.png",
    ...
    metaDescription:
      "Deploy precision agriculture IoT in minutes. Magistrala Smart Farming includes soil sensors, weather stations, irrigation automation, and crop dashboards.",
  },

  {
    ...
    dashboardScreenshots: [
      {
        src: "/img/solutions/oil-gas/field-operations-dashboard.png",
        alt: "Field Operations KPI Dashboard showing daily oil production, wellhead pressure, and H2S reading",
      },
      {
        src: "/img/solutions/oil-gas/real-time-monitoring-dashboard.png",
        alt: "Real-Time Well Monitoring Dashboard with live flow rate, wellhead pressure trend, and H2S concentration",
      },
      {
        src: "/img/solutions/oil-gas/well-operator-dashboard.png",
        alt: "Well Operator dashboard showing per-well flow rate, wellhead pressure gauge, and tank level",
      },
      {
        src: "/img/solutions/oil-gas/field-manager-summary-dashboard.png",
        alt: "Field Manager Summary with daily oil production chart and active alarms",
      },
    ],
    challenges: {
      ...
      items: [
        {
          ic: Wind,
          title: "H2S above threshold at an unmanned wellsite",
        ...
        },
        {
          ...
          desc: "When the transfer pump trips at midnight and nobody notices, crude keeps flowing into the tank. By morning the level is at 90% and the spill risk window is closing.",
        },
        {
          ic: TrendingUp,
          title: "Wellhead pressure trending toward MAOP between manual checks",
    ...
    howItWorks: {
      ...
      steps: [
        ...
        {
          title: "Detect",
          desc: "Five rules watch clean data continuously. Pressure above 1800 psi fires a warning; above 2200 psi fires critical. H2S above 5 ppm triggers a gas hazard warning. Tank above 85% triggers an overfill warning.",
        },
        {
          title: "Report",
    ...
    applications: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "Continuous OSHA-threshold monitoring at wellheads. Gas hazard alarms fire within seconds and reach on-call contacts by email.",
        },
        {
          ic: Database,
        ...
        },
        {
          ...
          desc: "Separator temperature and pressure trended for process upsets. Transfer pump status displayed and controllable from the KPI dashboard.",
        },
      ],
    },
    benefits: [
    ...
    metaDescription:
      "Monitor wellhead pressure, H2S concentration, oil flow, and tank levels in real time. Detect gas hazards and pressure excursions within seconds with Magistrala.",
  },

  {
    ...
    dashboardScreenshots: [
      {
        src: "/img/solutions/smart-irrigation/field-operations-dashboard.png",
        alt: "Field Operations Dashboard with zone soil moisture gauges, flow charts, tank level, and valve control switches",
      },
      {
        src: "/img/solutions/smart-irrigation/irrigation-analytics-dashboard.png",
        alt: "Irrigation Analytics Dashboard with 7-day soil moisture trends and daily water consumption",
      },
      {
        src: "/img/solutions/smart-irrigation/zone-monitoring-template.png",
        alt: "Zone Monitoring Template showing per-zone soil moisture, flow rate, rainfall, and valve control",
      },
      {
        src: "/img/solutions/smart-irrigation/alarms-dashboard.png",
        alt: "Alarm Monitoring Dashboard with active alarm counts by severity",
      },
    ],
    challenges: {
    ...
    howItWorks: {
      ...
      steps: [
        {
          title: "Ingest",
          desc: "Soil sensors, weather stations, flow meters, valves, and the pump controller publish SenML readings over MQTT, HTTP, CoAP, or WebSocket. Every raw reading is saved immediately.",
        },
        {
          title: "Detect",
          desc: "Six rules watch the incoming data continuously. Moisture drops below 35%? Dry soil warning. Flow spikes above 40 L/min? Pipe burst alarm. Tank below 25%? Refill warning.",
        },
        {
          title: "Control",
          desc: "Valve and pump switches on the Field Operations Dashboard send commands directly to actuators via the Commands Channel. Operators respond without leaving the monitoring view.",
        },
        {
          title: "Report",
    ...
    applications: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "Golf courses, sports grounds, and municipal parks monitor each irrigation zone independently. Pipe burst alarms prevent overnight water loss.",
        },
        {
          ic: Users,
          title: "Shared farmland and tenant irrigation accounts",
          desc: "Each farmer sees their own field's moisture history, water consumed, and device battery status. Aggregate consumption and alarm data stay with the farm manager.",
        },
      ],
    },
    benefits: [
    ...
    metaDescription:
      "Monitor soil moisture, flow rate, and tank level across irrigation zones. Detect dry soil, pipe bursts, and waterlogging within seconds with Magistrala.",
  },
    ...
    faq: [
      {
        ...
        answer:
          "Magistrala natively supports MQTT, HTTP, CoAP, and WebSocket. PM2.5, PM10, NO2, O3, CO, SO2, VOC, and CO2 sensors from major vendors are supported, both indoors and outdoors. Sensors using Modbus or LoRaWAN connect via an external protocol adapter.",
      },
      {
        question:
          "How are AQI thresholds configured for different regulatory standards?",
        answer:
          "WHO, US EPA, and EU Air Quality Directive thresholds are pre-configured as default rule templates. Each threshold set is adjustable per sensor, location, or jurisdiction. Regulatory standard updates can be applied by editing rule parameters.",
      },
      {
        question:
          "How does the platform handle multi-site monitoring networks?",
        answer:
          "Each monitoring station or network zone is organized as a Magistrala domain with its own sensors, rules, and access policies. Environmental agencies can manage multiple operator networks from a single platform while maintaining strict data isolation.",
      },
      {
        question: "How are automated compliance reports generated?",
        answer:
          "Compliance reports are generated on a configurable daily, weekly, or monthly schedule from raw sensor data. Reports include hourly averages, exceedance counts, and station metadata in formats accepted by major regulatory submission portals.",
      },
    ],
    metaDescription:
      "Deploy air quality monitoring in minutes. Magistrala Air Quality Pack includes multi-pollutant sensors, AQI rules, and automated compliance reporting.",
  },
];
